...
func main() {
	...
	TestIntegration(handlers)
}

func TestIntegration(handlers api.IApi) {
	...
	fmt.Printf("\tusers updated: %v\n", resStat.UpdateCount)
	fmt.Printf("\tget user: %v\n", resStat.GetUserCount)
	fmt.Printf("\tget all users: %v\n", resStat.GetUsersCount)
	fmt.Printf("\tdeleted users: %v\n", resStat.DeletedUsersAccount)
